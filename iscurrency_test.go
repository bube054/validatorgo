...
func TestIsCurrency(t *testing.T) {
	tests := []struct {
		...
		// ================================================================
		// Block 2: No decimals (AllowDecimal: false) - Valid
		// ================================================================
		{
			name:   "Block2 valid: -$10,123",
			param1: "-$10,123",
			param2: &IsCurrencyOpts{Symbol: "$", AllowNegatives: true, AllowDecimal: false, MaxDigitsAfterDecimal: 2},
			want:   true,
		},
		{
			name:   "Block2 valid: $10,123",
		...
		// ================================================================
		// Block 2: No decimals (AllowDecimal: false) - Invalid
		// ================================================================
		{
		...
		// ================================================================
		{
			...
			param1: "-$10,123.45",
			param2: &IsCurrencyOpts{Symbol: "$", AllowNegatives: true, AllowDecimal: true, RequireDecimal: true, MaxDigitsAfterDecimal: 2},
			want:   true,
		},
		{
			name:   "Block3 valid: $10,123.45",
		...
		// ================================================================
		{
			...
			param1: "-$10,123.45",
			param2: &IsCurrencyOpts{Symbol: "$", RequireSymbol: true, AllowNegatives: true, AllowDecimal: true, MaxDigitsAfterDecimal: 2},
			want:   true,
		},
		{
			name:   "Block4 valid: $10,123.45",
		...
		// ================================================================
		// Block 5: No negatives (AllowNegatives: false) - Valid
		// ================================================================
		{
			name:   "Block5 valid: $10,123.45",
			param1: "$10,123.45",
			param2: &IsCurrencyOpts{Symbol: "$", AllowNegatives: false, AllowDecimal: true, MaxDigitsAfterDecimal: 2},
			want:   true,
		},
		{
			name:   "Block5 valid: 10,123.45",
		...
		// ================================================================
		// Block 5: No negatives (AllowNegatives: false) - Invalid
		// ================================================================
		{
		...
		// TODO: should be valid per validator.js — ParensForNegatives check rejects non-parenthesized positive values (implementation requires both parens present)
		{
			...
			param1: "1,234",
			param2: &IsCurrencyOpts{Symbol: "$", AllowNegatives: true, ParensForNegatives: true, AllowDecimal: true, MaxDigitsAfterDecimal: 2},
			want:   false,
		},
		{
			name:   "Block6 valid: (1,234)",
