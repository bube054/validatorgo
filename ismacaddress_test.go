...
func TestIsMacAddress(t *testing.T) {
	tests := []struct {
		...
		{name: "Colon-separated EUI 64", param1: "00:1A:2B:3C:4D:5E:6F:70", param2: IsMacAddressOpts{Type: &EUIType64}, want: true},
		{name: "Hyphen-separated EUI 64", param1: "00-1A-2B-3C-4D-5E-6F-70", param2: IsMacAddressOpts{Type: &EUIType64}, want: true},
		{name: "Without separators (optional) EUI 64", param1: "001A2B3C4D5E6F70", param2: IsMacAddressOpts{Type: &EUIType64}, want: true},
		...
		{name: "Correct no separator EUI 64", param1: "001A2B3C4D5E6F70", param2: IsMacAddressOpts{NoSeparators: true, Type: &EUIType64}, want: true},
		// Invalid Mac address EUI 64, NoSeparators true
		{name: "Incorrect no separator  EUI 64", param1: "00-1A-2B-3C-4D-5E-6F-70", param2: IsMacAddressOpts{NoSeparators: true, Type: &EUIType64}, want: false},
	}
