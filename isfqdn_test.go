...
func TestIsFQDn(t *testing.T) {
	tests := []struct {
		...
		// Allow Trailing Dot
		{name: "Trailing dot is allowed, but no trailing dot is present", param1: "example.com", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true)}, want: true},
		{name: "Trailing dot is allowed, trailing dot is present", param1: "example.com.", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true)}, want: true},
		{name: "Trailing dot is allowed, trailing dot is present with multiple . delimiter", param1: "sub.example.com.", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true)}, want: true},
		{name: "Empty label", param1: "sub..com.", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true)}, want: false},
		{name: "Underscore not allowed", param1: "foo_bar.example.com.", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true)}, want: false},
		{name: "Numeric TLD not allowed", param1: "example.123", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true)}, want: false},
		...
		// Allow Underscores
		{name: "Underscore is allowed, but no underscore is present", param1: "example.com", param2: &IsFQDNOpts{AllowUnderscores: Bool(true)}, want: true},
		{name: "Underscore in label is allowed 1", param1: "sub_example.com", param2: &IsFQDNOpts{AllowUnderscores: Bool(true)}, want: true},
		{name: "Underscore in label is allowed 2", param1: "foo_bar.example.com", param2: &IsFQDNOpts{AllowUnderscores: Bool(true)}, want: true},
		{name: "Empty label", param1: "sub..com.", param2: &IsFQDNOpts{AllowUnderscores: Bool(true)}, want: false},
		{name: "Underscore not allowed", param1: "foo_bar.example.com.", param2: &IsFQDNOpts{AllowUnderscores: Bool(false)}, want: false},
		{name: "Numeric TLD not allowed", param1: "example.123", param2: &IsFQDNOpts{AllowUnderscores: Bool(true)}, want: false},
		...
		// Allow Numeric TLD
		{name: "Numeric TLD is allowed, but no numeric TLD is present", param1: "example.123", param2: &IsFQDNOpts{AllowNumericTld: Bool(true)}, want: true},
		{name: "Numeric TLD is allowed, but no numeric TLD is present", param1: "sub.example.456", param2: &IsFQDNOpts{AllowNumericTld: Bool(true)}, want: true},
		{name: "Underscore not allowed", param1: "foo_bar.example.com.", param2: &IsFQDNOpts{AllowUnderscores: Bool(false), AllowNumericTld: Bool(true)}, want: false},
		...
		// Ignore max length
		{name: "Max length ignored", param1: strings.Repeat("abc", 84) + ".com", param2: &IsFQDNOpts{IgnoreMaxLength: Bool(true)}, want: true},
		{name: "Max length is ignored", param1: strings.Repeat("abc", 84) + ".com", param2: &IsFQDNOpts{IgnoreMaxLength: Bool(false)}, want: false},
		...
		{name: "Valid numeric TLD no require: example.0", param1: "example.0", param2: &IsFQDNOpts{AllowNumericTld: Bool(true), RequireTld: Bool(false)}, want: true},
		{name: "Valid numeric TLD no require: 192.168.0", param1: "192.168.0", param2: &IsFQDNOpts{AllowNumericTld: Bool(true), RequireTld: Bool(false)}, want: true},
		// TODO: should be valid per validator.js — Go regex rejects label "9999" (>3 digits or label length issue)
		{name: "Valid numeric TLD no require: 192.168.0.9999", param1: "192.168.0.9999", param2: &IsFQDNOpts{AllowNumericTld: Bool(true), RequireTld: Bool(false)}, want: false},

		// ported from validator.js — allow_numeric_tld: true (require_tld defaults true)
		{name: "Valid allow_numeric_tld: google.com", param1: "google.com", param2: &IsFQDNOpts{AllowNumericTld: Bool(true), RequireTld: Bool(true)}, want: true},
		{name: "Valid allow_numeric_tld: google.l33t", param1: "google.l33t", param2: &IsFQDNOpts{AllowNumericTld: Bool(true), RequireTld: Bool(true)}, want: true},

		// ported from validator.js — allow_trailing_dot + allow_underscores + allow_numeric_tld
		{name: "Valid combined opts: abc.efg.g1h.", param1: "abc.efg.g1h.", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true), AllowUnderscores: Bool(true), AllowNumericTld: Bool(true)}, want: true},
		{name: "Valid combined opts: as1s.sad3s.ssa2d.", param1: "as1s.sad3s.ssa2d.", param2: &IsFQDNOpts{AllowTrailingDot: Bool(true), AllowUnderscores: Bool(true), AllowNumericTld: Bool(true)}, want: true},
