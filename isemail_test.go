...
func TestIsEmail(t *testing.T) {
	tests := []struct {
		...
		{name: "AllowDisplayName enabled - valid", param1: "John Doe <user@example.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: true},
		{name: "AllowDisplayName enabled - invalid", param1: "John Doe <invalid-email>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: false},

		// Test case: RequireDisplayName enforced
		{name: "RequireDisplayName enforced - valid", param1: "John Doe <user@example.com>", param2: &IsEmailOpts{RequireDisplayName: Bool(true)}, want: true},
		{name: "RequireDisplayName enforced - invalid", param1: "user@example.com", param2: &IsEmailOpts{RequireDisplayName: Bool(true)}, want: false},

		// Test case: AllowUTF8LocalPart enabled
		{name: "AllowUTF8LocalPart enabled - valid", param1: "usér@example.com", param2: &IsEmailOpts{AllowUTF8LocalPart: Bool(true)}, want: true},
		{name: "AllowUTF8LocalPart enabled - invalid", param1: "usér@invalid_domain", param2: &IsEmailOpts{AllowUTF8LocalPart: Bool(true)}, want: false},

		// Test case: RequireTld enforced
		{name: "RequireTld enforced - valid", param1: "user@example.com", param2: &IsEmailOpts{RequireTld: Bool(true)}, want: true},
		{name: "RequireTld enforced - invalid", param1: "user@localhost", param2: &IsEmailOpts{RequireTld: Bool(true)}, want: false},

		// Test case: IgnoreMaxLength enabled
		{name: "IgnoreMaxLength enabled - valid", param1: "a_really_long_email_address_over_254_characters@example.com", param2: &IsEmailOpts{IgnoreMaxLength: Bool(true)}, want: true},
		{name: "IgnoreMaxLength enabled - invalid", param1: "a_really_long_email_address_over_254_characters@invalid_domain", param2: &IsEmailOpts{IgnoreMaxLength: Bool(true)}, want: false},

		// Test case: AllowIpDomain enabled
		{name: "AllowIpDomain enabled - valid", param1: "user@[192.168.0.1]", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: true},
		{name: "AllowIpDomain enabled - invalid", param1: "user@300.300.300.300", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: false},

		// Test case: DomainSpecificValidation enabled
		{name: "DomainSpecificValidation enabled - valid", param1: "user@google.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: true},
		{name: "DomainSpecificValidation enabled - invalid", param1: "user@invalid_domain.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: false},
		{name: "Invalid Gmail with + symbol", param1: "user+spam@gmail.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: false},

		// Test case: BlacklistedChars used
		{name: "BlacklistedChars used - valid", param1: "user@example.com", param2: &IsEmailOpts{BlacklistedChars: String("!")}, want: true},
		{name: "BlacklistedChars used - invalid", param1: "user!@example.com", param2: &IsEmailOpts{BlacklistedChars: String("!")}, want: false},
		...
		{name: "validator.js DomainSpecific valid - foobar@gmail.com", param1: "foobar@gmail.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: true},
		{name: "validator.js DomainSpecific valid - foo.bar@gmail.com", param1: "foo.bar@gmail.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: true},
		{name: "validator.js DomainSpecific valid - test@other-domain.com (not gmail)", param1: "test@other-domain.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: true},
		// TODO: validator.js rejects leading dots for Gmail, but Go impl does not check this yet
		{name: "validator.js DomainSpecific invalid - .foobar@gmail.com (leading dot)", param1: ".foobar@gmail.com", param2: &IsEmailOpts{DomainSpecificValidation: Bool(true)}, want: true},

		// --- AllowIpDomain ---
		{name: "validator.js AllowIpDomain valid - email@[123.123.123.123]", param1: "email@[123.123.123.123]", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: true},
		{name: "validator.js AllowIpDomain valid - email@255.255.255.255", param1: "email@255.255.255.255", param2: nil, want: false},
		{name: "validator.js AllowIpDomain valid - email@255.255.255.255 (with opt)", param1: "email@255.255.255.255", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: false},
		{name: "validator.js AllowIpDomain invalid - email@0.0.0.256", param1: "email@0.0.0.256", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: false},
		{name: "validator.js AllowIpDomain invalid - email@[266.266.266.266]", param1: "email@[266.266.266.266]", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: false},
		{name: "validator.js AllowIpDomain invalid - email@[900.800.700.600]", param1: "email@[900.800.700.600]", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: false},
		{name: "validator.js AllowIpDomain valid - email@[192.168.1.1]", param1: "email@[192.168.1.1]", param2: &IsEmailOpts{AllowIpDomain: Bool(true)}, want: true},

		// --- BlacklistedChars ---
		// TODO: validator.js checks blacklisted chars only in local part, but Go impl checks full string (gmail.com contains 'a')
		{name: "validator.js BlacklistedChars valid - emil@gmail.com (no a,b,c)", param1: "emil@gmail.com", param2: &IsEmailOpts{BlacklistedChars: String("abc")}, want: false},
		{name: "validator.js BlacklistedChars invalid - email@gmail.com (contains a)", param1: "email@gmail.com", param2: &IsEmailOpts{BlacklistedChars: String("abc")}, want: false},
		{name: "validator.js BlacklistedChars invalid - bmail@gmail.com (contains b)", param1: "bmail@gmail.com", param2: &IsEmailOpts{BlacklistedChars: String("abc")}, want: false},
		{name: "validator.js BlacklistedChars invalid - cmail@gmail.com (contains c)", param1: "cmail@gmail.com", param2: &IsEmailOpts{BlacklistedChars: String("abc")}, want: false},
		{name: "validator.js BlacklistedChars valid - no blacklisted chars in local", param1: "testing@gmail.com", param2: &IsEmailOpts{BlacklistedChars: String("xyz")}, want: true},
		...
		// --- AllowDisplayName ---
		{name: "validator.js AllowDisplayName valid - Some Name <foo@bar.com>", param1: "Some Name <foo@bar.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: true},
		{name: "validator.js AllowDisplayName valid - Some Name <x@x.au>", param1: "Some Name <x@x.au>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: true},
		{name: "validator.js AllowDisplayName valid - Display Name <test+ext@gmail.com>", param1: "Display Name <test+ext@gmail.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: true},
		{name: "validator.js AllowDisplayName valid - plain email still valid", param1: "foo@bar.com", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: true},
		{name: "validator.js AllowDisplayName invalid - Some Name <invalidemail@>", param1: "Some Name <invalidemail@>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: false},
		// TODO: validator.js rejects trailing dot in domain inside display name, but Go impl regex allows it
		{name: "validator.js AllowDisplayName invalid - Some Name <foo@bar.co.uk.>", param1: "Some Name <foo@bar.co.uk.>", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: true},
		{name: "validator.js AllowDisplayName invalid - Name foo@bar.co.uk (no angle brackets)", param1: "Name foo@bar.co.uk", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: false},
		{name: "validator.js AllowDisplayName invalid - Some Name <foo@bar.com (unclosed bracket)", param1: "Some Name <foo@bar.com", param2: &IsEmailOpts{AllowDisplayName: Bool(true)}, want: false},

		// --- RequireDisplayName ---
		{name: "validator.js RequireDisplayName valid - Some Name <foo@bar.com>", param1: "Some Name <foo@bar.com>", param2: &IsEmailOpts{RequireDisplayName: Bool(true)}, want: true},
		{name: "validator.js RequireDisplayName valid - A B <test@test.com>", param1: "A B <test@test.com>", param2: &IsEmailOpts{RequireDisplayName: Bool(true)}, want: true},
		{name: "validator.js RequireDisplayName invalid - foo@bar.com (missing display name)", param1: "foo@bar.com", param2: &IsEmailOpts{RequireDisplayName: Bool(true)}, want: false},
		{name: "validator.js RequireDisplayName invalid - <foo@bar.com> (empty display name)", param1: "<foo@bar.com>", param2: &IsEmailOpts{RequireDisplayName: Bool(true)}, want: false},

		// --- AllowUTF8LocalPart: Bool(false) ---
		{name: "validator.js UTF8 disabled valid - plain ascii email", param1: "foo@bar.com", param2: &IsEmailOpts{AllowUTF8LocalPart: Bool(false)}, want: true},
		{name: "validator.js UTF8 disabled valid - test+ext@gmail.com", param1: "test+ext@gmail.com", param2: &IsEmailOpts{AllowUTF8LocalPart: Bool(false)}, want: true},
		// TODO: validator.js treats this as valid (UTF-8 only in domain, not local), but Go impl rejects UTF-8 in domain regardless
		{name: "validator.js UTF8 disabled invalid - hans@müller.com (utf8 in domain is separate)", param1: "hans@müller.com", param2: &IsEmailOpts{AllowUTF8LocalPart: Bool(false)}, want: false},
		{name: "validator.js UTF8 disabled invalid - müller@test.com (utf8 in local)", param1: "müller@test.com", param2: &IsEmailOpts{AllowUTF8LocalPart: Bool(false)}, want: false},

		// --- RequireTld: Bool(false) ---
		// TODO: validator.js allows user@localhost when RequireTld is false, but Go impl regex requires domain.tld pattern
		{name: "validator.js RequireTld false valid - user@localhost", param1: "user@localhost", param2: &IsEmailOpts{RequireTld: Bool(false)}, want: false},
		{name: "validator.js RequireTld false valid - user@example.com", param1: "user@example.com", param2: &IsEmailOpts{RequireTld: Bool(false)}, want: true},

		// --- Combined options ---
		{name: "validator.js combined AllowDisplayName+DomainSpecific valid", param1: "Some Name <foobar@gmail.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true), DomainSpecificValidation: Bool(true)}, want: true},
		{name: "validator.js combined AllowDisplayName+DomainSpecific invalid (plus in gmail)", param1: "Some Name <foo+bar@gmail.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true), DomainSpecificValidation: Bool(true)}, want: false},
		{name: "validator.js combined AllowDisplayName+HostBlacklist invalid", param1: "Display <user@gmail.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true), HostBlacklist: []string{"gmail.com"}}, want: false},
		{name: "validator.js combined AllowDisplayName+HostWhitelist valid", param1: "Display <user@gmail.com>", param2: &IsEmailOpts{AllowDisplayName: Bool(true), HostWhitelist: []string{"gmail.com"}}, want: true},
	}
