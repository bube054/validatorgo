...
func TestIsAlphanumeric(t *testing.T) {
	tests := []struct {
		...
		{name: "German locale alphanumeric check", param1: "äöüß123", param2: &IsAlphanumericOpts{Locale: String("de-DE")}, want: true},
		{name: "German locale with uppercase", param1: "Schön123", param2: &IsAlphanumericOpts{Locale: String("de-DE")}, want: true},
		{name: "Spanish locale alphanumeric check", param1: "ÁÉÍÓÚáéíóú123", param2: &IsAlphanumericOpts{Locale: String("es-ES")}, want: true},
