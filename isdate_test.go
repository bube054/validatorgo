...
func TestIsDate(t *testing.T) {
	tests := []struct {
		...
		{name: "Valid Slash Date", param1: "2007/01/02", param2: &IsDateOpts{Format: String(SlashDateLayout)}, want: true},
		{name: "Valid DateTime", param1: "2007-01-02 15:04:05", param2: &IsDateOpts{Format: String(DateTimeLayout)}, want: true},
		{name: "Valid ISO8601", param1: "2007-01-02T15:04:05", param2: &IsDateOpts{Format: String(ISO8601Layout)}, want: true},
		{name: "Valid ISO8601 Zulu", param1: "2007-01-02T15:04:05Z", param2: &IsDateOpts{Format: String(ISO8601ZuluLayout)}, want: true},
		{name: "Valid ISO8601 with Milliseconds", param1: "2007-01-02T15:04:05.000Z", param2: &IsDateOpts{Format: String(ISO8601WithMillisecondsLayout)}, want: true},
		{name: "Valid Any Format", param1: "2007-01-02", param2: &IsDateOpts{Format: String("any")}, want: true},
