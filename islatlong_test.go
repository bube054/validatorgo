...
func TestIsLatLong(t *testing.T) {
	tests := []struct {
		...
		{name: "Simple valid DMS", param1: `40°44'55"N, 73°59'11"W`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: true},
		{name: "With decimal seconds", param1: `40°44'55.5"N, 73°59'11.2"W`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: true},
		{name: "South and East", param1: `40°44'55"S, 73°59'11"E`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: true},
		// Invalid latlong withCheckDMS
		{name: "Minutes exceeding 59", param1: `40°60'00"N, 73°60'00"W`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: false},
		{name: "Missing direction N/S or E/W", param1: `40°44'55, 73°59'11"`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: false},
		{name: "Latitude exceeding valid range", param1: `100°00'00"N, 73°59'11"W`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: false},
		{name: "Incorrect separator ;", param1: `40°44'55.5"N; 73°59'11.2"W`, param2: &IsLatLongOpts{CheckDMS: Bool(true)}, want: false},
	}

	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			result, err := IsLatLong(test.param1, test.param2)
